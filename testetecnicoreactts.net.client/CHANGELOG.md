...
- Crie um projeto react com create-vite: `npm init --yes vite@latest testetecnicoreactts.net.client -- --template=react-ts`.
...
- Criar o arquivo de projeto (`testetecnicoreactts.net.client.esproj`).
